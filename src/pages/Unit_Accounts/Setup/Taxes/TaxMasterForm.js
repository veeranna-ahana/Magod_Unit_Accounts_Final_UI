  ...
  return (
    <div className="row">
      <div className="col-md-6 col-sm-12">
        <div
          style={{ height: "425px", overflowY: "scroll", overflowX: "scroll" }}
        >
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <td>
                        <input type="checkbox" checked={item.Service === 1} />
                      </td>
                      <td>
                        <input type="checkbox" checked={item.Sales === 1} />
                      </td>
                      <td>
                        <input type="checkbox" checked={item.JobWork === 1} />
                      </td>
                      <td>
                        <input type="checkbox" checked={item.IGST === 1} />
                      </td>
                      <td>
                        <input
                          type="checkbox"
      ...
      <div className="col-md-6 col-sm-12">
        ...
        <form
          className="form mt-5"
          style={{ height: "400px", marginLeft: "-30px" }}
        >
          <div className="row">
          ...
          <div className="row">
            <div className="d-flex col-md-6 mt-1" style={{ gap: "17px" }}>
              <label className="form-label" style={{ whiteSpace: "nowrap" }}>
                LedgerName
              </label>
              <input
